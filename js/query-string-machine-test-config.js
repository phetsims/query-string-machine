 ...
 * please modify query-string-machine/package.json to control dependencies.
 *
 * RequireJS configuration file for the query-string-machine sim.
 * Paths are relative to the location of this file.
 */

require.config( {

  deps: [ 'query-string-machine-tests' ],
